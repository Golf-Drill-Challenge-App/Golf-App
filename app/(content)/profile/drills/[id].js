...
export default function Stat() {
    ...
    const drillDataSorted = drillData["users"]["1"]["history"][slug].sort((a, b) => a.time - b.time)
    const data = drillDataSorted.map(value => value[drillData["drills"][slug]["mainOutputAttempt"]])
