// "jsx": "react-jsx" in tsconfig.json to ensure jsx doesn't cause some TypeScript error
    ...
    <SafeAreaView>
      ...
      <View>
        <YAxis
          ...
          // numberOfTicks={10}
          // I changed this from Stylesheet.create to style (vs. Frank's version) to fix a bug on web version (PC browser, yarn starttunnel)
          // NOTE: The labels under the graph won't be visible on dark mode in web version (PC browser, yarn starttunnel), use light mode
          // Also that you can only scroll and can't click to move the scroller on PC web browser?
          style={{
            position: "absolute",
            top: 0,
            bottom: 0,
